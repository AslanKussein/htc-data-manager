...
create table htc_db_dic_application_source (
id bigint constraint htc_db_dic_application_source_pkey
      primary key ,
...
COMMENT on table htc_db_dic_application_source is 'Справочник источника (создания) заявки';
