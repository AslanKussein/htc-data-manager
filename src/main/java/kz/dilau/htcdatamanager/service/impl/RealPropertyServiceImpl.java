...
public class RealPropertyServiceImpl implements RealPropertyService {
    ...
    public RealPropertyDto getById(Long id) {
        return mapToRealPropertyDto(realPropertyRepository.getOne(id));
    }

    public List<RealPropertyDto> getAll() {
        List<RealProperty> realPropertyList = realPropertyRepository.findAll();
        List<RealPropertyDto> realPropertyRequestDtoList = new ArrayList<>();
...
//        }
    ...
    public RealPropertyDto mapToRealPropertyDto(RealProperty realProperty) {
...
//        return RealPropertyDto.builder()
