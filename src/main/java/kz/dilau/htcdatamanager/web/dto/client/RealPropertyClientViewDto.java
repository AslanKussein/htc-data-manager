...
public class RealPropertyClientViewDto {
    ...
    private GeneralCharacteristicsClientViewDto generalCharacteristicsDto;
    ...
    public RealPropertyClientViewDto(RealProperty realProperty) {
        ...
        if (nonNull(metadata)) {
            ...
            this.generalCharacteristicsDto = new GeneralCharacteristicsClientViewDto(metadata.getGeneralCharacteristics());
        }
    ...
    public RealPropertyClientViewDto(RealProperty realProperty, Long applicationId) {
        this.buildingDto = new BuildingDto(realProperty.getBuilding());
        this.cadastralNumber = realProperty.getCadastralNumber();
        this.apartmentNumber = realProperty.getApartmentNumber();
