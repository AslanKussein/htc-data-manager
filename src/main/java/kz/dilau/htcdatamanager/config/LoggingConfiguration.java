...
//                                Optional<BuildProperties> buildProperties, ApplicationProperties applicationProperties) {
//        this.appName = appName;
//        this.serverPort = serverPort;
//        this.version = buildProperties.isPresent() ? buildProperties.get().getVersion() : "";
//        this.applicationProperties = applicationProperties;
//        if (this.applicationProperties.getLogging().isUseJsonFormat()) {
//            addJsonConsoleAppender(context);
//        }
//        if (this.applicationProperties.getLogging().getLogstash().isEnabled()) {
//            addLogstashTcpSocketAppender(context);
//        }
//        if (this.applicationProperties.getLogging().isUseJsonFormat() || this.applicationProperties.getLogging().getLogstash().isEnabled()) {
...
//        logstashAppender.addDestinations(new InetSocketAddress(this.applicationProperties.getLogging().getLogstash().getHost(), this.applicationProperties.getLogging().getLogstash().getPort()));
...
//        asyncLogstashAppender.setQueueSize(this.applicationProperties.getLogging().getLogstash().getQueueSize());
...
//        LogbackLoggerContextListener loggerContextListener = new LogbackLoggerContextListener(this.applicationProperties);
...
//                        && !(appender.getName().equals(CONSOLE_APPENDER_NAME) && this.applicationProperties.getLogging().isUseJsonFormat())) {
...
//
//        private LogbackLoggerContextListener(ApplicationProperties applicationProperties) {
//            this.applicationProperties = applicationProperties;
//        }
//
//        @Override
